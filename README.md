...
### 2. Клонировать репо и поднять контейнер
...
Первая сборка — 5–10 минут (pull `archlinux:latest`, установка ~30 пакетов, `go install` инструментов). После — секунды на старт.
